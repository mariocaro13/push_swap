...
/*   Updated: 2025/02/03 17:21:24 by mcaro-ro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_test_movement_operations(t_stack **a, t_stack **b)
{
	...
	if (ft_test_rotate_operations(*a, *b) != 0)
	{
		ft_printf(RED TEST_FAILED ROTATE_FAILED RESET_COLOR);
		return (1);
	}
	if (ft_test_reverse_rotate_operations(*a, *b) != 0)
	{
		ft_printf(RED TEST_FAILED REVERSE_ROTATE_FAILED RESET_COLOR);
		return (1);
	}
	return (0);
}
